<template>
    <el-dialog title="编辑部门配额" :visible.sync="isShow" width="600px"   v-dialogDrag>
...
import {createQuota,changeDeptQuota,searchDeptDetail} from '@/service/usermgr/deptmgr.js';
export default {
    data() {
        return{
    ...
    methods: {
        ...
        create(){
            this.form.quota.deptId = this.brunch.id;
