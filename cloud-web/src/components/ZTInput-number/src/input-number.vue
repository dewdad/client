<template>
    <div @dragstart.prevent :class="[
      ...
      { 'is-controls-right': controlsAtRight }
        ...
        <el-input :placeholder="placeholder" ref="input" v-tooltip="{'content':tooltip, theme: 'is-light', hideOnTargetClick: false, autoHide: false}" :value="currentInputValue" :disabled="inputNumberDisabled" :size="inputNumberSize" :max="max" :min="min" :name="name" :label="label" @keydown.up.native.prevent="increase" @keydown.down.native.prevent="decrease" @blur="handleBlur" @focus="handleFocus" @change="handleInputChange">
...
export default {
    ...
    computed: {
        ...
        currentInputValue() {
            const currentValue = this.currentValue ? this.currentValue : this.min;
