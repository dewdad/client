    ...
    <div>
        ...
        <el-row>
            <el-col :span="24">
                ...
                <el-table v-loading="loading" :data="tableData" stripe border class="data-list ">
                ...
                <el-tab-pane label="备份设置" name="setting">
                        <div v-if="activeName==='setting'" class="mt10">
                            <div class="search-box">
                                <zt-form size="small" ref="policy" :model="policy" label-width="130px" inline-message>
                                    <zt-form-item label="备份周期">
                                    ...
                                    <zt-form-item label="备份时间" prop="starttime" :rules="[{required: true, message: '请选择备份时间', trigger: ['change']}]">
                                        <el-time-picker style="width:300px" v-if="isShow" v-model="policy.starttime" :picker-options="{ selectableRange: '00:0:00 - 23:59:59'}" placeholder="任意时间点"></el-time-picker>
                                        <span v-if="!isShow">{{policy.starttime|date('HH:mm:ss')}}</span>
                                    </zt-form-item>
                                    <zt-form-item label="备份保留">
                                        <el-input-number style="width:300px" v-if="isShow" v-model="policy.keepday" controls-position="right" :min="1" :max="30"></el-input-number>
                                        <span v-if="!isShow">{{policy.keepday}}</span>
                                    </zt-form-item>
                                    <zt-form-item label="备份开关">
                                    ...
                                    <zt-form-item v-if="isShow" label="">
                                        <el-button type="info" @click="isShow=false">取消</el-button>
                                         <el-button type="primary" @click="updatePolicy">确定</el-button>
                                    </zt-form-item>
                                </zt-form>
                            </div>
                        </div>
