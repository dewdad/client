...
import {deleteNetwork} from '@/service/ecs/network.js';
import {getFirewallList} from '@/service/ecs/firewall.js';
    ...
    methods: {
        ...
        async fetchData() {
            try {
                ...
                let ret = await getFirewallList(params);
