...
export const MONITOR_RULE_TYPES = [
    ...
    {key: 'cpu_util', value: 'cpu使用率', unit: '%', type: 'instance'},
    {key: 'mem_util', value: '内存使用率', unit: '%', type: 'instance'},
    {key: 'network_incoming_bytes_aggregate_rate', value: '带外网络流入速率', unit: 'byte/s', type: 'instance'},
    {key: 'network_outgoing_bytes_aggregate_rate', value: '带外网络流出速率', unit: 'byte/s', type: 'instance'},
    {key: 'disk_read_bytes_rate', value: '磁盘读速率', unit: 'byte/s', type: 'instance'},
    {key: 'disk_read_requests_rate', value: '磁盘读操作速率', unit: 'Frequency', type: 'instance'},
    {key: 'disk_write_bytes_rate', value: '磁盘写速率', unit: 'byte/s', type: 'instance'},
    {key: 'disk_write_requests_rate', value: '磁盘写操作速率', unit: 'Frequency', type: 'instance'},
